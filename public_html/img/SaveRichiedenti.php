...
<?php 
	...
	<div id="navigazione"><div id="navvoci"><?php printMenu_1($titolo); ?></div><div id="logout"><a href='index.php'>LOG OUT</a></div><div style="clear:both; margin:0px; padding:0px; font-size:2px;">&nbsp;</div></div><?php
