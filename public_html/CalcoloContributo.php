...
<div id="testocalcolo">
    ...
    if (mysql_num_rows($rs_richiedenti) > 0) {
      while ($record = mysql_fetch_object($rs_richiedenti)) {
        ...
        if ($lavaut == "A") {
          ...
          //se il richiedente � un lavoratore dipendente c'� l'ulteriore abbattimento del 40%
        ...
        if ($redimpannuo <= $pensioneminimainps2) {
          ...
          if ($incidenza >= $percincida) {
            ...
            if ($fabbisogno > $canoneannuo) {
              $fabbisogno = $canoneannuo;
            }
            if ($fabbisogno > $maxcontributoa) {
              $fabbisogno = $maxcontributoa;
            }
          }
          else {
            $escluso = "S";
            $motivoesclusione = "L\'incidenza � inferiore al " . $percincida;
          }
        }
        elseif ($redconv <= $redditoerp) {
          ...
          if ($lavaut == "A") {
            ...
            //se il richiedente � un lavoratore dipendente c'� l'ulteriore abbattimento dle 40%
            $redconv = round(($detrazioni * (100 - $percabb) / 100), 2);
          }
          if ($redconv < 0) {
            $redconv = 0;
          ...
          if ($incidenza >= $percincidb) {
            ...
            if ($fabbisogno > $maxcontributob) {
              $fabbisogno = $maxcontributob;
            }
          }
          else {
            $escluso = "S";
            $motivoesclusione = "L\'incidenza � inferiore al " . $percincidb;
          }
        }
        else {
          ...
          //se anche in questo caso supera i limiti consentiti, c'� l'esclusione
          ...
          elseif ($redconv <= $redditoerp) {
            ...
            //Il reddito del Richiedente supera i limiti consentiti e quindi non pu� usufruire del contributo
            $escluso = "S";
  ...
  //sono stati tolti i commenti perch� la funzione per il 2006 include campi differenti
  if ($anno <= 2005) {
