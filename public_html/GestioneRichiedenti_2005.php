...
function azione(operazione,codice) 
{
	...
	if (operazione=="Cancellazione") { 
		 document.box.action="SaveRichiedenti.php"; 
	 }
	else if (operazione=="Duplicazione") { 
		 document.box.action="SaveRichiedenti.php"; 
	 }
	else if (operazione=="Inserimento") { 
		 document.box.action="Richiedenti.php?Cod=0"; 
	 }
	else if (operazione=="Modifica") { 
		 document.box.action="Richiedenti.php?Cod=" + codice; 
	 }
...
<h2 class="hide" align="left">&raquo; Gestione Richiedenti</h2>
	...
	<form method='POST' action="Richiedenti.php?Cod=0" name="box" onSubmit="return validate()">
	<fieldset>
...
<table width="99%"  border="0" align="center" cellpadding="1" cellspacing="1" class="box">
  <tr class="grigio1">
    <td width="10%"><div align="left"><input type='checkbox'   name="c"  onclick="ToggleCheckAll()">Tutti</div></td>
    ...
    <th width="20%" scope="col"><div align="left">REDDITO IMP.</div></th>
    <th width="20%" scope="col"><div align="left">CANONE LOC.</div></th>
  </tr>
...
?>
			...
			<td><a href="Richiedenti.php?Cod=<? echo $codice; ?>"><? echo $cognome; ?></a></td>
			<td><? echo $nome; ?></td>
			<td><? echo $indirizzo; ?></td>
			<td><? echo $redimpannuo; ?></td>
			<td><? echo $canoneannuo; ?></td>
			<tr><td colspan="6" id="clear"><hr /></td></tr>
		</tr>
<?php
