		...
		if (mysql_num_rows($rs_configurazione)>0) {	
			...
			if (mysql_num_rows($rs_richiedenti)>0) {
				...
				while ($record = mysql_fetch_object($rs_richiedenti)) {
					...
					if (($ultra65 == "S" | $handicap == "S" | $altradebolezza == "S") & ($aumentarelimiti == "S")) {
					...
					//Verifica se il reddito rispetta il requisito fascia A
						...
						if ($incidenza >= $percincida) {
							...
							$fabbisogno = round(($incidenza14 / 12 * $mesiloc), 2);
								...
								//$fabbisogno = round(($fabbisogno + ($fabbisogno * $percincr / 100)), 2);
							...
							if ($fabbisogno > $canoneannuo) {$fabbisogno = $canoneannuo; }
                    					...
                    					//rs_tabella("incidenza") = incidenza
                    					//rs_tabella("incidenza14") = incidenza14
                    					//rs_tabella("fabbisogno") = fabbisogno
                
                				}
						else {
	
                    					//rs_tabella("redconv") = 0
                    					//rs_tabella("incidenza") = incidenza
                    					//rs_tabella("incidenza14") = 0
                   					//rs_tabella("fabbisogno") = 0
                    					//rs_tabella("contributo") = 0
                    					//rs_tabella("escluso") = "S"
                    					//rs_tabella("motivoesclusione") = "L'incidenza è inferiore al " & percincida
						...
						if ($incidenza >= $percincidb) {
							...
							//rs_tabella("redconv") = redconv
                   					...
                   					//rs_tabella("incidenza14") = 0
                    					...
                    					//rs_tabella("contributo") = 0
                    					//rs_tabella("escluso") = "S"
                    					//rs_tabella("motivoesclusione") = "L'incidenza è inferiore al " & percincidb	
					...
					//Il reddito del Richiedente supera i limiti consentiti e quindi non può usufruire del contributo
						...
						//rs_tabella("redconv") = 0
                				//rs_tabella("incidenza") = 0
                				//rs_tabella("incidenza14") = 0
               					//rs_tabella("fabbisogno") = 0
                				//rs_tabella("contributo") = 0
                				//rs_tabella("escluso") = "S"
                				//rs_tabella("motivoesclusione") = "Il Reddito supera i limiti consentiti sia per la Fascia A che per la B"
