...
//	$this->xheaders['To'] = implode( ", ", $this->sendto );
	...
	if( $this->charset != "" ) {
		...
		$this->xheaders["Content-Type"] = "text/html; charset=iso-8859-1";
		$this->xheaders["Content-Transfer-Encoding"] = $this->ctencoding;
	        $this->xheaders["X-Mailer"] = "Microsoft Office Outlook, Build 11.0.5510";
                $this->xheaders["X-MimeOLE"] = "Produced By Microsoft MimeOLE V6.00.2800.1441";
        }
...
function Send()
{
	...
	$destinatario=$this->strTo; #echo "Destinatario: ".$destinatario."<br>";
	$oggetto=$this->xheaders['Subject']; #echo "Oggetto: ".$oggetto."<br>";
	$corpox=$this->fullBody; #echo "Corpo: ".$corpo."<br>";
	$corpo=preg_replace("(\r)", "\n", $corpox); 
	$intestazione=$this->headers; #echo "Intestazione: ".$intestazione."<br>";
	
	// envoie du mail
	// $res = mail( $this->strTo, $this->xheaders['Subject'], $this->fullBody, $this->headers );
	$res = mail ($destinatario,$oggetto,$corpo,$intestazione);
