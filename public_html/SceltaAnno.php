...
<h2 class="hide" align="left">&raquo; Gestione Richiedenti</h2>
	...
	<form method='POST' action="GestioneRichiedenti.php" name="box" >
	<fieldset>
      <legend>Modulo per la Scelta dell'Anno della Gestione dei Richiedenti</legend><br>
