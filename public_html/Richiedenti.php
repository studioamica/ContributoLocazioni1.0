...
if (document.box.modificadati.value==1) {
	...
	if  (document.box.cfiscale.value.length != 16 ) {
		msg = msg + "Inserire o Verificare il Codice Fiscale\n";
	}

	if ((document.box.lavaut.value == "A") && (document.box.lavdip.value == "D") ) {
		msg = msg + "Controllare la tipologia del Lavoratore (Autonomo/Dipendente)\n";
	}
...
?>
	<form method='POST' action='SaveRichiedenti.php' name='box' onSubmit='return validate()'>
...
<div>
 <div id="contenitore">
			...
			<tr><td>Lav. Autonomo</td><td>  <select size='1' name="lavaut" id="lavaut">
              			<option selected value="<? echo $lavaut; ?>"><? echo $lavaut; ?></option>
              			<option value="A">A</option>
              			<option value=""></option>
              		</select></td></tr><tr><td>Lav. Dipendente</td><td> <select size='1' name="lavdip" id="lavdip">
              			<option selected value="<? echo $lavdip; ?>"><? echo $lavdip; ?></option>
...
<div id="moduli">			<h2><strong>Alloggio</strong></h2>
			...
			</select></td></tr><tr><td colspan="2">&nbsp;&nbsp;</td></tr></table>
</div>
<div id="clear">&nbsp;</div>
<div id="moduli"><h2><strong>Informazioni sul Contratto</strong></h2>
			...
			<tr><td>Non Specificato </td><td><select size='1' name="nonspecificato" id="nonspecificato">
              			<option selected value="<? echo $nonspecificato; ?>"><? echo $nonspecificato; ?></option>
              			<option value="S">S</option>
              			<option value="N">N</option>
              		</select></td></tr>
