...
<?php 
	...
	$titolo = array(""=>"Scelta Anno Configurazione Parametri");
...
<h2 class="hide" align="left">&raquo; Gestione Richiedenti</h2>
	...
	<form method='POST' action="Parametri.php" name="box" >
	<fieldset>
      <legend>Modulo per la Scelta dell'Anno dei Parametri di Configurazione</legend><br>
